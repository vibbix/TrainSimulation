...
public class EndToEndTests {
    ...
    public void fullLoopTest(){
        ...
        Passenger p1 = new Passenger(l, tr.getStations().get(2), null, tr.getStations().get(0), 0);
        Passenger p2 = new Passenger(l, tr.getStations().get(2), null, tr.getStations().get(0), 1);
        Passenger p3 = new Passenger(l, tr.getStations().get(2), null, tr.getStations().get(0), 2);
